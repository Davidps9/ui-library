...
export default function assignButtonStyles(props) {
    var buttonStyles = props.SButtonclass + '';
    var variant = props.variant, fontColor = props.fontColor, size = props.size, disabled = props.disabled, borderColor = props.borderColor, rounded = props.rounded, focusable = props.focusable;
